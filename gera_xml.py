...
<cUF>52</cUF>
<cNF>{cNF}</cNF>
<natOp>6107 VENDA PRODUCAO ESTAB DESTINADA A NAO CONTRIBUINTE 610</natOp>
<mod>55</mod>
<serie>106</serie>
<nNF>{nNF}</nNF>
<dhEmi>{dhEmi}</dhEmi>
...
<xProd>Produto Teste {produto_id}</xProd>
<NCM>61091000</NCM>
<qCom>1.0000</qCom>
<vUnCom>{preco}</vUnCom>
<vProd>{preco}</vProd>
...
<vTotTrib>{vTotTrib}</vTotTrib>
    ...
    for i in range(num_nfes):
        ...
        cpf = "{}{}{}.{}{}{}.{}{}{}-{}{}".format(*random.choices("0123456789", k=11))
        nome_dest = f"Cliente {random.randint(1, 500)}"
